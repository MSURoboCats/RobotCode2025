...
#include "custom_interfaces/msg/detail/map_object__rosidl_typesupport_fastrtps_c.h"
...
using _MapObject__ros_msg_type = custom_interfaces__msg__MapObject;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _MapObject__ros_msg_type * ros_message = static_cast<const _MapObject__ros_msg_type *>(untyped_ros_message);
  // Field name: mesh
  {
  ...
  // Field name: aabb
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, custom_interfaces, msg, AABB
      )()->data);
    if (!callbacks->cdr_serialize(
        &ros_message->aabb, cdr))
    {
      return false;
    }
  }
  ...
  void * untyped_ros_message)
{
  ...
  _MapObject__ros_msg_type * ros_message = static_cast<_MapObject__ros_msg_type *>(untyped_ros_message);
  // Field name: mesh
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _MapObject__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_interfaces__msg__MapObject(
  ...
  size_t current_alignment)
{
  ...
  // member: aabb
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_custom_interfaces__msg__AABB(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
static size_t _MapObject__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_interfaces__msg__MapObject(
...
static message_type_support_callbacks_t __callbacks_MapObject = {
