...
static rosidl_typesupport_introspection_c__MessageMember custom_interfaces__msg__ImuData__rosidl_typesupport_introspection_c__ImuData_message_member_array[5] = {
  {
    ...
    offsetof(custom_interfaces__msg__ImuData, global_time_seconds),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_interfaces__msg__ImuData, angular_velocity),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_interfaces__msg__ImuData, linear_acceleration),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, custom_interfaces, msg, ImuData)() {
  custom_interfaces__msg__ImuData__rosidl_typesupport_introspection_c__ImuData_message_member_array[1].members_ =
