...
class ImuData(metaclass=Metaclass_ImuData):
    ...
    @builtins.property
    def global_time_seconds(self):
        """Message field 'global_time_seconds'."""
        return self._global_time_seconds

    @global_time_seconds.setter
    def global_time_seconds(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'global_time_seconds' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'global_time_seconds' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._global_time_seconds = value
