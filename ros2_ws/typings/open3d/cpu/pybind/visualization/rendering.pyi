...
import typing
__all__ = ['Camera', 'ColorGrading', 'Gradient', 'MaterialRecord', 'OffscreenRenderer', 'Open3DScene', 'Renderer', 'Scene', 'TriangleMeshModel', 'View']
class Camera:
    """
    Camera object
    """
...
class Renderer:
    ...
    """
    def add_texture(self, image: open3d.cpu.pybind.geometry.Image, is_sRGB: bool = False) -> ...:
        """
        ...
        """
    def remove_texture(self, texture: ...) -> None:
        """
    ...
    def set_clear_color(self, arg0: numpy.ndarray[numpy.float32[4, 1]]) -> None:
        ...
        """
    def update_texture(self, texture: ..., image: open3d.cpu.pybind.geometry.Image, is_sRGB: bool = False) -> bool:
        """
