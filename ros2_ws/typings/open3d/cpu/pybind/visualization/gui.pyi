...
class Application:
    ...
    def add_window(self, arg0: ...) -> None:
        ...
        """
    def create_window(self, title: str = '', width: int = -1, height: int = -1, x: int = -1, y: int = -1, flags: int = 0) -> ...:
        """
    ...
    def initialize(self, arg0: str) -> None:
        ...
        """
    def post_to_main_thread(self, arg0: ..., arg1: typing.Callable[[], None]) -> None:
        """
