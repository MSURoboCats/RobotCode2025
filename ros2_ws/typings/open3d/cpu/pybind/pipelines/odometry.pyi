...
class RGBDOdometryJacobianFromHybridTerm(RGBDOdometryJacobian):
    ...
    def __repr__(self) -> str:
        ...
def compute_correspondence(intrinsic_matrix, extrinsic, depth_s, depth_t, option = ...):
    """
    ...
    Args:
        ...
        option (open3d.pipelines.odometry.OdometryOption, optional): Odometry hyper parameters. Default value:
    ...
    """
def compute_rgbd_odometry(rgbd_source, rgbd_target, pinhole_camera_intrinsic = ..., odo_init = ..., jacobian = ..., option = ...):
    """
    ...
    Args:
        ...
        pinhole_camera_intrinsic (open3d.camera.PinholeCameraIntrinsic, optional): Camera intrinsic parameters Default value:
    
            PinholeCameraIntrinsic with width = -1 and height = -1.
            Access intrinsics with intrinsic_matrix.
        odo_init (numpy.ndarray[numpy.float64[4, 4]], optional): Initial 4x4 motion matrix estimation. Default value:
