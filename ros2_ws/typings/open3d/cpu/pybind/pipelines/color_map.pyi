...
class NonRigidOptimizerOption:
    ...
    """
    def __init__(self, number_of_vertical_anchors = 16, non_rigid_anchor_point_weight = 0.316, maximum_iteration = 0, maximum_allowable_depth = 2.5, depth_threshold_for_visibility_check = 0.03, depth_threshold_for_discontinuity_check = 0.1, half_dilation_kernel_size_for_discontinuity_map = 3, image_boundary_margin = 10, invisible_vertex_color_knn = 3, debug_output_dir = ''):
        """
        Args:
...
class RigidOptimizerOption:
    ...
    """
    def __init__(self, maximum_iteration = 0, maximum_allowable_depth = 2.5, depth_threshold_for_visibility_check = 0.03, depth_threshold_for_discontinuity_check = 0.1, half_dilation_kernel_size_for_discontinuity_map = 3, image_boundary_margin = 10, invisible_vertex_color_knn = 3, debug_output_dir = ''):
        """
        Args:
            maximum_iteration (int, optional, default=0): int: (Default ``300``) Number of iterations for optimization steps.
            maximum_allowable_depth (float, optional, default=2.5): float: (Default ``2.5``) Parameter to check the visibility of a point. Points with depth larger than ``maximum_allowable_depth`` in a RGB-D will be marked as invisible for the camera producing that RGB-D image. Select a proper value to include necessary points while ignoring unwanted points such as the background.
