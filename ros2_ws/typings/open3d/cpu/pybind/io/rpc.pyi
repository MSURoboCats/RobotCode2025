...
def set_mesh_data(*args, **kwargs):
    ...
    Args:
        ...
        time (int, optional, default=0): The time associated with this data.
        layer (str, optional, default=''): The layer associated with this data.
        vertices (open3d.core.Tensor, optional): Tensor defining the vertices. Default value:
    
            0-element Tensor
            Tensor[shape={0}, stride={1}, Float32
         ()
        vertex_attributes (Dict[str, open3d.core.Tensor], optional, default={}): dict of Tensors with vertex attributes.
        faces (open3d.core.Tensor, optional): Tensor defining the faces with vertex indices. Default value:
    
            0-element Tensor
            Tensor[shape={0}, stride={1}, Int32
         ()
        face_attributes (Dict[str, open3d.core.Tensor], optional, default={}): dict of Tensors with face attributes.
        lines (open3d.core.Tensor, optional): Tensor defining lines with vertex indices. Default value:
