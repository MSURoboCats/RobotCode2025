...
class Metaclass_MapObject(type):
    """Metaclass of message 'MapObject'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__map_object
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__map_object
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__map_object
            cls._TYPE_SUPPORT = module.type_support_msg__msg__map_object
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__map_object

            from custom_interfaces.msg import AABB
            if AABB.__class__._TYPE_SUPPORT is None:
                AABB.__class__.__import_type_support__()
...
class MapObject(metaclass=Metaclass_MapObject):
    """Message class 'MapObject'."""
    ...
    def mesh(self, value):
        if __debug__:
            ...
            assert \
                ...
                "The 'mesh' field must be a sub message of type 'Polygon'"
        self._mesh = value
